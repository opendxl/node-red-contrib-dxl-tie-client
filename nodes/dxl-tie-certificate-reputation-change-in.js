/**
 * @module DxlTieCertificateReputationChangeIn
 * @description Implementation of the
 * `dxl-tie-certificate-reputation-change in` node
 * @private
 */
...
module.exports = function (RED) {
   ...
   * receive `certificate reputation` change events.
   ...
   *   payloadType is 'bin', `msg.payload` is a raw binary Buffer. If payloadType
   *   is 'txt', `msg.payload` is a String (decoded as UTF-8). If payloadType
   *   is 'obj', is an Object (decoded as a JSON document from the original
  ...
  function TieCertificateReputationChangeInNode (nodeConfig) {
    ...
    /**
     * Controls the data type for the certificate reputation change event
     * payload.
     * @type {String}
     * @private
     */
